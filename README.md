# blocktrain.fi Smart Contracts

blocktrain.fi is a yield farming game that simulates DeFi market dynamics, liquidity mechanics and on-chain credit. Players deploy digital assets to maximize returns through lending, staking and trading in a way that educates on crypto-economic principles in a risk-managed environment.
