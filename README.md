# blocktrain.defi Smart Contracts

blocktrain.defi is a yield farming game that simulates DeFi market dynamics, liquidity mechanics and on-chain credit. Players deploy digital assets to maximize returns through lending, staking and trading in a way that educates on crypto-economic principles in a risk-managed environment.
...
![BORROW-USDC-LP-NFT.png](docs/media/BORROW-USDC-LP-NFT.png)
