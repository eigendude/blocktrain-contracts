...
describe("Bureau 1: Dutch Auction", () => {
  ...
  it("should test routes", async function (): Promise<void> {
    ...
    chai
      .expect(await dutchAuctionContract.borrowToken())
    ...
    chai
      .expect(await dutchAuctionContract.borrowStableSwapper())
  ...
  it("should check initial LP-SFT LPYIELD balance", async function (): Promise<void> {
    ...
    // Calculate DeFi properties
    // TODO: Calculate LPYIELD price instead of using BORROW price
