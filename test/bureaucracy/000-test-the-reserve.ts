...
describe("The Reserve Smart Contract", () => {
  ...
  it("should test routes", async function (): Promise<void> {
    ...
    const {
      ...
      borrowContract,
      borrowLpNftStakeFarmContract,
      borrowLpSftLendFarmContract,
      borrowStablePoolContract,
      borrowStablePoolerContract,
      borrowStableSwapperContract,
      theReserveContract,
    ...
    chai
      .expect(await theReserveContract.borrowToken())
      .to.equal(borrowContract.address);
    chai
    ...
    chai
      .expect(await theReserveContract.borrowStablePool())
      .to.equal(borrowStablePoolContract.address);
    chai
    ...
    chai
      .expect(await theReserveContract.borrowStableSwapper())
      .to.equal(borrowStableSwapperContract.address);
    chai
    ...
    chai
      .expect(await theReserveContract.borrowStablePooler())
      .to.equal(borrowStablePoolerContract.address);
    chai
      .expect(await theReserveContract.yieldLpNftStakeFarm())
      .to.equal(yieldLpNftStakeFarmContract.address);
    chai
      .expect(await theReserveContract.borrowLpNftStakeFarm())
      .to.equal(borrowLpNftStakeFarmContract.address);
    chai
      .expect(await theReserveContract.yieldLpSftLendFarm())
      .to.equal(yieldLpSftLendFarmContract.address);
    chai
      .expect(await theReserveContract.borrowLpSftLendFarm())
      .to.equal(borrowLpSftLendFarmContract.address);
    chai
