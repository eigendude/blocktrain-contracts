 ...
 */
contract BORROWStableSwapper is
  Context,
  ReentrancyGuard,
  UniV3Swapper,
  IGameTokenSwapper
{
   ...
   * @param borrowMarketPool_ The address of the pool contract for the token pair
   */
  constructor(
    address borrowToken_,
    address marketToken_,
    address borrowMarketPool_
  ) UniV3Swapper(borrowToken_, marketToken_, borrowMarketPool_) {}
