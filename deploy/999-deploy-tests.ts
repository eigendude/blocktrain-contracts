...
const func: DeployFunction = async (hardhat_re: HardhatRuntimeEnvironment) => {
  ...
  //
  // Deploy TestBORROWStableStaker
  //

  console.log(`Deploying ${TEST_BORROW_STABLE_STAKER_CONTRACT}`);
  await deployments.deploy(TEST_BORROW_STABLE_STAKER_CONTRACT, {
    ...opts,
    args: [
      deployer, // owner
      ...
      addressBook.yieldToken!, // rewardToken
      addressBook.borrowStablePool!, // borrowStablePool
      addressBook.borrowStablePooler!, // borrowStablePooler
      addressBook.uniswapV3NftManager!, // uniswapV3NftManager
      addressBook.uniswapV3Staker!, // uniswapV3Staker
      addressBook.lpSft!, // lpSft
    ],
